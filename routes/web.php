...
// AJAX API routes for auction data
Route::get('/api/auctions/{auctionId}/recent-bids', [HomeController::class, 'getRecentBids'])->name('api.auction.recent-bids');
Route::get('/api/auctions/{auctionId}/auto-bid-status', [HomeController::class, 'getAutoBidStatus'])->name('api.auction.auto-bid-status');
